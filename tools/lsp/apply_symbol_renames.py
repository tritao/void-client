...
This is the method/variable counterpart to tools/lsp/apply_jdtls_renames.py, but it
            ...
            raise SystemExit(
                "\n".join(
                    [
                        ...
                        "  python tools/lsp/apply_symbol_renames.py --jdtls-home /path/to/jdtls",
                        "  python tools/lsp/apply_symbol_renames.py --jdtls-cmd <full jdtls command...>",
                        "",
