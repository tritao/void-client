...
token-based approach in tools/refactor/apply_class_renames.py is too risky.
...
def main(argv: list[str]) -> int:
    ...
    ap.add_argument("--csv", type=Path, default=Path("client/refactor/.refactor-plan/generated/classes.csv"))
            ...
            raise SystemExit(
                "\n".join(
                    [
                        ...
                        "  python tools/lsp/apply_jdtls_renames.py --jdtls-home /path/to/jdtls",
                        "  python tools/lsp/apply_jdtls_renames.py --jdtls-cmd <full jdtls command...>",
                        "",
