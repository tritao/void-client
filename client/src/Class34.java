...
final class Class34 {
    ...
    private final void method344(int i, RSBuffer class348_sub49, byte i_10_) {
        if (i != 1) {
            if (i == 2) {
    ...
    final void method346(int i, RSBuffer class348_sub49) {
        anInt467++;
        for (; ; ) {
    ...
    static final void method349(int i) {
        ...
        for (int i_33_ = 0; i_33_ < i_32_; i_33_++) {
            Player player = AwtLoadingScreen.aPlayerArray5058[is[i_33_]];
            if (player != null) MonochromeImageCache.method2556(false, player.method2436((byte) 60), player);
        }
