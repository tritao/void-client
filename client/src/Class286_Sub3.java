...
final class Class286_Sub3 extends Class286 {
    ...
    Class286_Sub3(GlToolkit var_ha_Sub2, Class83 class83) {
        super(var_ha_Sub2);
        do {
            try {
        ...
        if (Class73.anInt4776 < 400) {
            ...
            if (class79.aBoolean1396) {
                ...
                if (class79.anInt1361 != 0) {
                    String string_15_ = ((Class14_Sub4.aClass230_8638 != Class348_Sub42_Sub8_Sub2.aClass230_10434) ? LocalisedText.aClass274_3511.method2063(Class348_Sub33.anInt6967, 544) : LocalisedText.aClass274_3513.method2063(Class348_Sub33.anInt6967, 544));
                ...
                if (!bool) {
                    ...
                    if (strings != null) {
                        for (int i = 4; i >= 0; i--) {
                            if (strings[i] != null && (class79.aByte1384 == 0 || !(strings[i].equalsIgnoreCase(LocalisedText.aClass274_3506.method2063(Class348_Sub33.anInt6967, 544))))) {
                                int i_16_ = 0;
                                if (i == 0) i_16_ = 25;
                                ...
                                Class229.anInt2976++;
                                Class50_Sub3.method466(false, "<col=ffff00>" + string, 0, (byte) -93, false, 0, -1, true, i_16_, npc.anInt10290, strings[i], npc.anInt10290, (!(strings[i].equalsIgnoreCase(LocalisedText.aClass274_3506.method2063(Class348_Sub33.anInt6967, 544))) ? i_17_ : class79.anInt1401));
                            }
                        }
                    }
                    if (class79.aByte1384 == 1 && strings != null) {
                        for (int i = 4; i >= 0; i--) {
                            if (strings[i] != null && (strings[i].equalsIgnoreCase(LocalisedText.aClass274_3506.method2063(Class348_Sub33.anInt6967, 544)))) {
                                short i_18_ = 0;
                ...
                Class50_Sub3.method466(bool, "<col=ffff00>" + string + Loader.getDebug(class79.anInt1344, npcX, npcY, npc.plane), 0, (byte) -105, bool_14_, 0, -1, true, 1008, npc.anInt10290, LocalisedText.aClass274_3505.method2063(Class348_Sub33.anInt6967, 544), npc.anInt10290, Class286_Sub8.anInt6299);
            }
        }
    }
