...
final class Class287 {
    ...
    private final Interface12 method2182(boolean bool, Class223 class223, RSBuffer class348_sub49) {
        try {
            anInt3692++;
            if (Class219.aClass223_2868 == class223) return VarpDomain.method1312((byte) 64, class348_sub49);
            if (RSBuffer.aClass223_7175 == class223) return Class105_Sub1.method987(743571200, class348_sub49);
    ...
    final void method2183(RSBuffer class348_sub49, int i) {
