            ...
            try {
                ...
                try {
                    if (string.equalsIgnoreCase("commands") || string.equalsIgnoreCase("help")) {
                        GameShell.method94("commands - This command", i ^ 0x1);
                        GameShell.method94("cls - Clear console", -54);
                        GameShell.method94("displayfps - Toggle FPS and other information", -89);
                        GameShell.method94("renderer - Print graphics renderer information", 122);
                        GameShell.method94("heap - Print java memory information", -88);
                        break;
                    }
                    ...
                    if (string.equalsIgnoreCase("displayfps")) {
                        ...
                        if (Class298.aBoolean3811) GameShell.method94("FPS on", 83);
                        else {
                            GameShell.method94("FPS off", -69);
                            break;
                        }
                        break;
                    }
                    if (string.equals("renderer")) {
                        ...
                        GameShell.method94("Vendor: " + class365.anInt4476, 89);
                        GameShell.method94("Name: " + (class365.aString4470), 71);
                        GameShell.method94(("Version: " + (class365.anInt4475)), -110);
                        GameShell.method94(("Device: " + (class365.aString4472)), i + 146);
                        GameShell.method94(("Driver Version: " + (class365.aLong4471)), i + -32);
                        break;
                    }
                    if (string.equals("heap")) {
                        GameShell.method94(("Heap: " + Class226.anInt2964 + "MB"), 69);
                        break;
                    }
                } catch (Exception exception) {
                    GameShell.method94((LocalisedText.aClass274_3485.method2063(Class348_Sub33.anInt6967, 544)), -99);
                    break;
                }
                if (Class8.aClass364_165 != Class55_Sub1.aClass364_5271 || Class192.anInt2581 >= 2) {
                    ...
                    try {
                        if (string.equalsIgnoreCase("printfps")) {
                            GameShell.method94(("FPS: " + Class239_Sub5.anInt5891), -58);
                            break;
                        }
                        if (string.equalsIgnoreCase("occlude")) {
                            ...
                            if (Class348_Sub40_Sub23.aBoolean9307) {
                                GameShell.method94("Occlsion now on!", -102);
                                break;
                            } else GameShell.method94("Occlsion now off!", -106);
                            break;
                        }
                        if (string.equalsIgnoreCase("fpson")) {
                            Class298.aBoolean3811 = true;
                            GameShell.method94("fps debug enabled", -115);
                            break;
                        }
                        if (string.equalsIgnoreCase("fpsoff")) {
                            Class298.aBoolean3811 = false;
                            GameShell.method94("fps debug disabled", 125);
                            break;
                        }
                        if (string.equals("systemmem")) {
                            try {
                                GameShell.method94(("System memory: " + (jagmisc.getAvailablePhysicalMemory() / 1048576L) + "/" + Class348_Sub40_Sub20.aClass348_Sub4_9264.anInt6609 + "Mb"), i + 26);
                        ...
                        if (string.equalsIgnoreCase("cleartext")) {
                            ...
                            GameShell.method94("Text coords cleared", i + 21);
                            break;
                        }
                        if (string.equalsIgnoreCase("gc")) {
                            ...
                            GameShell.method94("mem=" + i_2_ + "k", 110);
                            break;
                        }
                        if (string.equalsIgnoreCase("compact")) {
                            ...
                            GameShell.method94(("Memory before cleanup=" + i_4_ + "k"), 115);
                            ...
                            GameShell.method94(("Memory after cleanup=" + i_4_ + "k"), -110);
                            break;
                        }
                        if (string.equalsIgnoreCase("unloadnatives")) {
                            GameShell.method94((Class228.method1629(true) ? "Libraries unloaded" : "Library unloading failed!"), 63);
                            break;
                        }
                        if (string.equalsIgnoreCase("clientdrop")) {
                            GameShell.method94("Dropped client connection", -119);
                        ...
                        if (string.equalsIgnoreCase("breakcon")) {
                            ...
                            GameShell.method94("Breaking new connections for 5 seconds", i + -4);
                            break;
                        }
                        if (string.equalsIgnoreCase("rebuild")) {
                            Class348_Sub20.method2953((byte) -117);
                            Class50_Sub2.method464(-1);
                            GameShell.method94("Rebuilding map", -113);
                            break;
                        }
                        if (string.equalsIgnoreCase("rebuildprofile")) {
                            ...
                            Class50_Sub2.method464(-1);
                            GameShell.method94("Rebuilding map (with profiling)", -117);
                            break;
                        }
                        if (string.equalsIgnoreCase("wm1")) {
                            Class85.method830(1, -1, (byte) 102, false, -1);
                            if (Class348_Sub42_Sub12.method3229(-61) == 1) {
                                GameShell.method94("wm1 succeeded", -65);
                                break;
                            } else GameShell.method94("wm1 failed", i ^ ~0x17);
                            break;
                        }
                        if (string.equalsIgnoreCase("wm2")) {
                            Class85.method830(2, -1, (byte) 102, false, -1);
                            if (Class348_Sub42_Sub12.method3229(-119) == 2) GameShell.method94("wm2 succeeded", -109);
                            else {
                                GameShell.method94("wm2 failed", i + 154);
                                break;
                            }
                            break;
                        }
                        if (string.equalsIgnoreCase("wm3")) {
                            ...
                            if (Class348_Sub42_Sub12.method3229(i ^ 0x3d) == 3) GameShell.method94("wm3 succeeded", 111);
                            else {
                                GameShell.method94("wm3 failed", 83);
                                break;
                            }
                            break;
                        }
                        if (string.equalsIgnoreCase("tk0")) {
                            ...
                            if (Class316.aClass348_Sub51_3959.aClass239_Sub25_7271.method1829(-32350) == 0) {
                                GameShell.method94("Entered tk0", 101);
                                ...
                                break;
                            } else GameShell.method94("Failed to enter tk0", 69);
                            break;
                        }
                        if (string.equalsIgnoreCase("tk1")) {
                            ...
                            if (Class316.aClass348_Sub51_3959.aClass239_Sub25_7271.method1829(-32350) == 1) {
                                GameShell.method94("Entered tk1", -65);
                                ...
                                r.aBoolean9719 = false;
                                break;
                            } else GameShell.method94("Failed to enter tk1", -56);
                            break;
                        }
                        ...
                        if (string.equalsIgnoreCase("tk5")) {
                            ...
                            if (Class316.aClass348_Sub51_3959.aClass239_Sub25_7271.method1829(i ^ 0x7e13) == 5) {
                                GameShell.method94("Entered tk5", -108);
                                Class316.aClass348_Sub51_3959.method3429((byte) 74, (Class316.aClass348_Sub51_3959.aClass239_Sub25_7251), 5);
                                Class14_Sub2.method243(37);
                                r.aBoolean9719 = false;
                            } else {
                                GameShell.method94("Failed to enter tk5", 63);
                                break;
                            }
                            break;
                        }
                        if (string.startsWith("setba")) {
                            if (string.length() < 6) GameShell.method94("Invalid buildarea value", i + -36);
                            else {
                                int i_6_ = (Class348_Sub41.method3156(true, string.substring(6)));
                                if (i_6_ < 0 || (Class348.method2710(-126, Class226.anInt2964) < i_6_)) GameShell.method94("Invalid buildarea value", 53);
                                else {
                                    Class316.aClass348_Sub51_3959.method3429((byte) 74, (Class316.aClass348_Sub51_3959.aClass239_Sub6_7226), i_6_);
                                    Class14_Sub2.method243(37);
                                    r.aBoolean9719 = false;
                                    GameShell.method94(("maxbuildarea=" + Class316.aClass348_Sub51_3959.aClass239_Sub6_7226.method1743(-32350)), 98);
                                    break;
                                }
                                break;
                            }
                        ...
                        if (string.startsWith("rect_debug")) {
                            if (string.length() < 10) GameShell.method94("Invalid rect_debug value", -94);
                            else {
                                ha_Sub3.anInt8045 = Class348_Sub41.method3156(true, string.substring(10).trim());
                                GameShell.method94(("rect_debug=" + ha_Sub3.anInt8045), -124);
                                break;
                            }
                            break;
                        }
                        if (string.equalsIgnoreCase("qa_op_test")) {
                            ...
                            GameShell.method94(("qa_op_test=" + (Class299_Sub2.aBoolean6327)), -114);
                            break;
                        }
                        if (string.equalsIgnoreCase("clipcomponents")) {
                            Class318_Sub1_Sub3_Sub2.aBoolean10046 = !Class318_Sub1_Sub3_Sub2.aBoolean10046;
                            GameShell.method94(("clipcomponents=" + (Class318_Sub1_Sub3_Sub2.aBoolean10046)), 88);
                            break;
                        }
                        if (string.startsWith("bloom")) {
                            ...
                            if (Class348_Sub40_Sub33.method3137(!bool_7_, (byte) -24)) {
                                if (bool_7_) {
                                    GameShell.method94("Bloom disabled", i + -49);
                                    break;
                                } else GameShell.method94("Bloom enabled", 71);
                                break;
                            } else GameShell.method94("Failed to enable bloom", 52);
                            break;
                        }
                        if (string.equalsIgnoreCase("tween")) {
                            if (Class28.aBoolean5002) {
                                Class28.aBoolean5002 = false;
                                GameShell.method94("Forced tweening disabled.", i ^ ~0x71);
                                break;
                            } else {
                                Class28.aBoolean5002 = true;
                                GameShell.method94("Forced tweening ENABLED!", -89);
                            }
                            break;
                        }
                        if (string.equalsIgnoreCase("shiftclick")) {
                            if (Class116.shiftClick) {
                                GameShell.method94("Shift-click disabled.", i ^ ~0x24);
                                Class116.shiftClick = false;
                            } else {
                                GameShell.method94("Shift-click ENABLED!", 106);
                        ...
                        if (string.equalsIgnoreCase("getcgcoord")) {
                            GameShell.method94(("x:" + ((Class132.aPlayer_1907.x) >> 9) + " z:" + ((Class132.aPlayer_1907.y) >> 9)), -117);
                            break;
                        }
                        if (string.equalsIgnoreCase("getheight")) {
                            GameShell.method94(("Height: " + (aa_Sub1.aSArray5191[(Class132.aPlayer_1907.plane)].method3982((byte) -86, (Class132.aPlayer_1907.y) >> 9, (Class132.aPlayer_1907.x) >> 9))), i ^ 0x1);
                            break;
                        }
                        if (string.equalsIgnoreCase("resetminimap")) {
                            ...
                            Class50_Sub2.method464(-1);
                            GameShell.method94("Minimap reset", 70);
                            break;
                        }
                        if (string.startsWith("mc")) {
                            if (Class348_Sub8.aHa6654.method3708()) {
                                ...
                                GameShell.method94(("Render cores now: " + (Class239_Sub16.anInt6012)), -77);
                            } else {
                                GameShell.method94("Current toolkit doesn't support multiple cores", i + 138);
                                break;
                            }
                            break;
                        }
                        if (string.startsWith("cachespace")) {
                            GameShell.method94(("I(s): " + Class351.aClass60_4327.method581(-18529) + "/" + Class351.aClass60_4327.method577(-4)), -101);
                            GameShell.method94(("I(m): " + Class358.aClass60_4417.method581(-18529) + "/" + Class358.aClass60_4417.method577(i ^ 0x4d)), 127);
                            GameShell.method94(("O(s): " + Exception_Sub1.aClass255_112.aClass175_3288.method1350((byte) 126) + "/" + Exception_Sub1.aClass255_112.aClass175_3288.method1339(100)), i + 203);
                            break;
                        }
                        ...
                        if (string.equals("renderprofile") || string.equals("rp")) {
                            ...
                            GameShell.method94(("showprofiling=" + Class188.aBoolean2514), 106);
                            break;
                        }
                        if (string.startsWith("performancetest")) {
                            ...
                            if (i_9_ == -1) {
                                GameShell.method94(("Java toolkit: " + Class239_Sub14.method1781(0, -85, i_10_)), i + -32);
                                GameShell.method94(("SSE toolkit:  " + Class239_Sub14.method1781(2, -73, i_10_)), 60);
                                GameShell.method94(("D3D toolkit:  " + Class239_Sub14.method1781(3, i + -24, i_10_)), i ^ ~0x11);
                                GameShell.method94(("GL toolkit:   " + Class239_Sub14.method1781(1, -84, i_10_)), -121);
                                GameShell.method94(("GLX toolkit:  " + Class239_Sub14.method1781(5, -77, i_10_)), -101);
                                break;
                            } else GameShell.method94(("Performance: " + Class239_Sub14.method1781(i_9_, -69, i_10_)), -84);
                            break;
                        }
                        if (string.equals("nonpcs")) {
                            Class373_Sub2.aBoolean7444 = !Class373_Sub2.aBoolean7444;
                            GameShell.method94("nonpcs=" + (Class373_Sub2.aBoolean7444), -120);
                            break;
                        }
                        if (string.equals("autoworld")) {
                            Class348_Sub42_Sub20.method3283(127);
                            GameShell.method94("auto world selected", -59);
                            break;
                        }
                        if (string.startsWith("switchworld")) {
                            ...
                            GameShell.method94("switched", 70);
                            break;
                        }
                        if (string.equals("getworld")) {
                            GameShell.method94(("w: " + (Class3.aClass161_125.anInt2143)), -120);
                            break;
                        }
                        ...
                        if (string.equals("savevarcs")) {
                            ...
                            GameShell.method94("perm varcs saved", -103);
                            break;
                        }
                        if (string.equals("scramblevarcs")) {
                            for (int i_14_ = 0; (i_14_ < IsaacCipher.anIntArray1303.length); i_14_++) {
                                if (Class286_Sub6.aBooleanArray6270[i_14_]) {
                                    IsaacCipher.anIntArray1303[i_14_] = (int) (Math.random() * 99999.0);
                                    if (Math.random() > 0.5) IsaacCipher.anIntArray1303[i_14_] *= -1;
                                }
                            }
                            Class318_Sub1_Sub2.method2405(-61);
                            GameShell.method94("perm varcs scrambled", -74);
                            break;
                        }
                        if (string.equals("showcolmap")) {
                            Class375.aBoolean4542 = true;
                            Class50_Sub2.method464(-1);
                            GameShell.method94("colmap is shown", 53);
                            break;
                        }
                        if (string.equals("hidecolmap")) {
                            Class375.aBoolean4542 = false;
                            Class50_Sub2.method464(i ^ 0x4e);
                            GameShell.method94("colmap is hidden", 61);
                            break;
                        }
                        if (string.equals("resetcache")) {
                            Class348_Sub18.method2938((byte) 122);
                            GameShell.method94("Caches reset", -113);
                            break;
                        }
                        if (string.equals("profilecpu")) {
                            GameShell.method94((Class284.method2116(-26584) + "ms"), 87);
                            break;
                        }
                        if (string.startsWith("getclientvarpbit")) {
                            int i_15_ = Integer.parseInt(string.substring(17));
                            GameShell.method94("varpbit=" + Class318_Sub1_Sub3_Sub3.aClass170_10209.method62(i_15_, i ^ 0xffb1), i + 198);
                            break;
                        }
                        if (string.startsWith("getclientvarp")) {
                            int i_16_ = Integer.parseInt(string.substring(14));
                            GameShell.method94("varp=" + Class318_Sub1_Sub3_Sub3.aClass170_10209.method61(i_16_, (byte) -16), -68);
                            break;
                        }
                        ...
                        if (string.equals("soundstreamcount")) {
                            GameShell.method94(("Active streams: " + Class348_Sub43.aClass348_Sub16_Sub4_7065.method2887()), 84);
                            break;
                        }
                        if (string.equals("autosetup")) {
                            Class318_Sub1_Sub4.method2478(1000);
                            GameShell.method94(("Complete. Toolkit now: " + Class316.aClass348_Sub51_3959.aClass239_Sub25_7271.method1829(i + -32271)), -97);
                            break;
                        }
                        if (string.equals("errormessage")) {
                            GameShell.method94(NPCType.aClient1367.method81((byte) 102), 102);
                            break;
                        }
                        if (string.equals("heapdump")) {
                            if (!SignLink.aString3803.startsWith("win")) Class158.method1247(new File("/tmp/heap.dump"), false, false);
                            else Class158.method1247(new File("C:\\Temp\\heap.dump"), false, false);
                            GameShell.method94("Done", 74);
                            break;
                        }
                        if (string.equals("os")) {
                            GameShell.method94("Name: " + SignLink.aString3803, 59);
                            GameShell.method94(("Arch: " + SignLink.aString3780), i ^ ~0x1);
                            GameShell.method94("Ver: " + SignLink.aString3778, 79);
                            break;
                        }
                        if (string.startsWith("w2debug")) {
                            ...
                            GameShell.method94("Toggled!", -99);
                            break;
                        }
                        if (string.startsWith("ortho ")) {
                            int i_20_ = string.indexOf(' ');
                            if (i_20_ < 0) GameShell.method94("Syntax: ortho <n>", 66);
                            else {
                                ...
                                if (Class316.aClass348_Sub51_3959.aClass239_Sub3_7222.method1727(-32350) == i_21_) {
                                    GameShell.method94("Successfully changed ortho mode", -82);
                                    break;
                                } else GameShell.method94("Failed to change ortho mode", -112);
                                break;
                            }
                            break;
                        }
                        if (string.startsWith("orthozoom ")) {
                            if (Class316.aClass348_Sub51_3959.aClass239_Sub3_7222.method1727(i + -32271) == 0) GameShell.method94("enable ortho mode first (use 'ortho <n>')", i + 182);
                            else {
                                int i_22_ = (Class348_Sub41.method3156(true, string.substring(string.indexOf(' ') - -1)));
                                Class132.anInt1911 = i_22_;
                                GameShell.method94(("orthozoom=" + Class132.anInt1911), 68);
                                break;
                            }
                            break;
                        }
                        if (string.startsWith("orthotilesize ")) {
                            ...
                            GameShell.method94("ortho tile size=" + i_23_, -70);
                        ...
                        if (string.equals("orthocamlock")) {
                            ...
                            GameShell.method94(("ortho camera lock is " + (!(Class348_Sub49_Sub1.aBoolean9746) ? "off" : "on")), -92);
                            break;
                        }
                        if (string.startsWith("setoutput ")) {
                            ...
                            if (file.exists()) {
                                ...
                                if (file.exists()) {
                                    GameShell.method94("file already exists!", 80);
                                    break;
                                }
                            }
                            ...
                            try {
                                ...
                                GameShell.method94(("Could not create " + file.getName()), 81);
                            } catch (SecurityException securityexception) {
                                GameShell.method94(("Cannot write to " + file.getName()), i ^ ~0x22);
                            }
                            break;
                        }
                        ...
                        if (string.startsWith("runscript ")) {
                            File file = new File(string.substring(10));
                            if (!file.exists()) {
                                GameShell.method94("No such file", 120);
                                break;
                            }
                            byte[] is = Class239_Sub24.method1821(i ^ 0x41, file);
                            if (is == null) {
                                GameShell.method94("Failed to read file", 119);
                                break;
                            }
                        ...
                        if (string.startsWith("zoom ")) {
                            ...
                            if (i_24_ > 0) InterfaceList.aShort3992 = i_24_;
                            break;
                        }
                        ...
                        GameShell.method94(LocalisedText.aClass274_3485.method2063(Class348_Sub33.anInt6967, 544), -92);
                        break;
                    }
                }
                if (Class240.anInt4674 == 10) break;
                GameShell.method94(LocalisedText.aClass274_3486.method2063(Class348_Sub33.anInt6967, 544) + string, 57);
