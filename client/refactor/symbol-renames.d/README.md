# Symbol rename shards (`symbol-renames.d/`)
...
- Put one or more `*.csv` files under subfolders that mirror the *refactor layout* domains:
  - `client/refactor/symbol-renames.d/client/`
  - `client/refactor/symbol-renames.d/ui/`
  - `client/refactor/symbol-renames.d/graphics/`
  - `client/refactor/symbol-renames.d/world/`
  - `client/refactor/symbol-renames.d/cache/`
  - ...
...
2. Every `*.csv` under `--csv-dir` (defaults to `client/refactor/symbol-renames.d/`, recursive; lexical order)
